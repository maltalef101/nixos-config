(custom-set-variables
 ...
 '(package-selected-packages
   '(editorconfig rainbow-mode format-all c-mode swiper treemacs-evil vue-mode eslintd-fix column-enforce-mode csv csv-mode rust-mode tree-sitter-indent clang-format json-mode rjsx-mode web-mode emmet-mode yaml-mode yaml company-auctex auctex crontab-mode yasnippet-snippets yasnippet cmake-mode flycheck emojify ws-butler tree-sitter-langs tree-sitter modern-cpp-font-lock diredfl dired-hide-dotfiles dired-open dired-single all-the-icons-dired python-mode js2-mode typescript-mode company-box company lsp-ivy lsp-treemacs lsp-ui lsp-mode button-lock magit counsel-projectile projectile general treemacs helpful which-key rainbow-delimiters counsel ivy-rich ivy evil-collection undo-fu-session undo-fu doom-modeline evil no-littering auto-package-update doom-themes use-package))
